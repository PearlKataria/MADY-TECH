  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home" screenOptions={{
        ...
        <Stack.Screen name="SchizophreniaScreen" component={SchizophreniaScreen}/>
        <Stack.Screen name="ObsessiveCompulsiveDisorderScreen" component={ObsessiveCompulsiveDisorderScreen}/>
        <Stack.Screen name="SocialPhobiaScreen" component={SocialPhobiaScreen}/>
